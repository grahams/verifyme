...
\begin{document}
  ...
  \begin{resume_list}
    \item Drove a very important product push to launch Vizit NextGen
        to market. Defended engineers from competing priorities and
        distractions.
    \item Guided the team through the rise of agent-driven coding, setting
        policy, evaluating tools, and resolving the occasional conflict. 
    \item Oversaw doubling the size of our engineering staff, developed
        standard onboarding procedures, and ensured success of all new team
        members.
    \item Worked closely with Product and Go-To-Market to ensure success.
  \end{resume_list}
  ...
  \headingBf{RIT Center for Imaging Science}{March 2000 -- October 2000}
